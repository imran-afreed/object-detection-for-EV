...
# Load Yolo
net = cv2.dnn.readNet("trained_dataset.weights", "yolov3_testing.cfg")
...
for img_path in images_path:
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            #cv2.rectangle(img, (x, y), (x + w, y - 10), (20, 255, 10), -1)
            #cv2.putText(img, label, (x, y ), font, 0.8, (0, 0, 0), 1)
            cv2.putText(img, confi, (x, y ), font, 0.5, (20, 255, 10), 1)
